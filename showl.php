...
<body>
  ...
  $result = mysqli_query($con, $query); 
   ?>
    <div class="container">
        <button type="button" class="btn btn-light btn-lg btn-block">ຜູ້ຍິງຫຼືຜູ້ຊາຍທີ່ທ່ານເລືອກ</button>
          ...
          <?php while($row = mysqli_fetch_array($result)){
            ...
            echo"<div class='card-body'>
                    ...
                    <button type='button' class='btn-close' data-dismiss='modal' aria-label='Close'></button>
                     ...
                     <p class=''>ເວລາທຳງານ: ".$row['tim']."<p>ບ້ານ: ".$row['vilage']."</p>"."<p>ເມືອງ: ".$row['city']."</p>"."<p>ແຂວງ: ".$row['provin']."</p>"."<p>ເບີໂທລະສັບ: ".$row['numberphome']."</p>"."</p>
                     </div>
                    <div class='modal-footer'>
                    <button type='button' class='btn btn-danger' data-dismiss='modal'>ບໍ່ຈ່ອງ</button>
                    <a href='http://api.whatsapp.com/send?phone=+85697348433'><button  class='btn btn-info'>ຈ່ອງ</button></a>
                     </div>
                    </div>
                    </div>
                  </div>
